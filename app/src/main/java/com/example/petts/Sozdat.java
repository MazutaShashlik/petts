...
public class Sozdat extends AppCompatActivity {
    ...
    public void OnClickCreate(View view) {
        if (TextUtils.isEmpty(editPetName.getText().toString()) ||
            ...
            Toast.makeText(Sozdat.this, "Заполните все поля.", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void createPet(Pet pet) {
        ...
        call.enqueue(new Callback<Pet>() {
            ...
            public void onResponse(Call<Pet> call, Response<Pet> response) {
                ...
                Toast.makeText(Sozdat.this, success, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<Pet> call, Throwable t) {
                Toast.makeText(Sozdat.this, t.toString(), Toast.LENGTH_SHORT).show();
